...
import { components_sidebar_links, installation_sidebar_links, sidebar_links } from "@/constants/components_showcase/sidebar_links"
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          {isInstallationOpen && (
            <SidebarGroupContent>
              <SidebarMenu>
              {installation_sidebar_links.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <a href={item.url}>
                      <item.icon />
        ...
        <SidebarGroup>
          ...
          {isComponentsOpen && (
            <SidebarGroupContent>
              <SidebarMenu>
              {components_sidebar_links.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <a href={item.url}>
                      <item.icon />
